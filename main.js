  ...
  const getAllTodos = (todos, main) => {
    ...
    for (const todo in todos) {
      todos[todo].forEach((todo, i) => {
        ...
        const day = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dateValue, 'do');
        const month = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dateValue, 'MMM');
