...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*, *::after, *::before {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  user-select: none; }\n\nhtml {\n  font-size: 100%;\n  overflow-x: hidden; }\n  @media (max-width: 1000px) {\n    html {\n      font-size: 90%; } }\n  @media (max-width: 800px) {\n    html {\n      font-size: 80%; } }\n  @media (max-width: 650px) {\n    html {\n      font-size: 70%; } }\n  @media (max-width: 400px) {\n    html {\n      font-size: 60%; } }\n\nbody {\n  display: grid;\n  overflow-x: hidden;\n  grid-template-columns: 20rem 1fr;\n  grid-template-rows: 5rem 1fr;\n  width: 100vw;\n  height: 100vh;\n  font-family: Overpass, sans-serif;\n  color: #f5f5f5; }\n  @media (max-width: 1000px) {\n    body {\n      grid-template-columns: 17rem 1fr; } }\n  @media (max-width: 800px) {\n    body {\n      grid-template-columns: 13rem 1fr; } }\n  @media (max-width: 650px) {\n    body {\n      grid-template-columns: 10rem 1fr; } }\n  @media (max-width: 540px) {\n    body {\n      grid-template-columns: 1fr 20rem; } }\n\n.header {\n  background-color: #8EE4AF;\n  grid-column: 1 / 3;\n  grid-row: 1 / 2;\n  display: flex;\n  font-family: Impact, Overpass, sans-serif;\n  transition: all 0.5s ease;\n  font-size: 3.5rem;\n  font-weight: 500;\n  align-items: center;\n  justify-content: center;\n  padding: 0.5rem; }\n  @media (max-width: 540px) {\n    .header-text {\n      flex: auto;\n      transition: 0.2s ease-in-out; } }\n\n.sidebar {\n  background-color: #379683;\n  grid-column: 1 / 2;\n  grid-row: 2 / 3;\n  padding: 3rem;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  font-size: 2rem; }\n  @media (max-width: 800px) {\n    .sidebar {\n      padding: 1.5rem; } }\n  @media (max-width: 540px) {\n    .sidebar {\n      padding: 1rem;\n      position: relative;\n      grid-column: 2;\n      left: 1000px;\n      transition: 0.2s ease-in-out; } }\n\n.main {\n  background-color: #5CDB95;\n  grid-column: 2 / 3;\n  grid-row: 2 / 3;\n  padding: 2rem; }\n  @media (max-width: 540px) {\n    .main {\n      grid-column: 1 / 3; } }\n\nbutton {\n  cursor: pointer;\n  border: solid 2px #55d1b6;\n  background: #f5f5f5;\n  text-align: center;\n  font-weight: bold;\n  border-radius: 4px;\n  color: #0b0b0f; }\n  button:hover {\n    transition: ease-in 0.2s;\n    cursor: pointer;\n    color: #f5f5f5; }\n  button:active {\n    transform: scale(0.8); }\n\n.header-container {\n  display: flex; }\n\n.menu {\n  list-style: none; }\n  .menu-item {\n    cursor: pointer;\n    padding: 1rem;\n    transition: all 0.5s ease; }\n    .menu-item:hover {\n      color: #05386B;\n      font-weight: 700;\n      transform: translateX(0.5rem); }\n\n.highlighted {\n  color: #05386B;\n  font-weight: 700;\n  transform: translateX(0.5rem);\n  cursor: pointer;\n  padding: 1rem;\n  transition: all 0.5s ease; }\n\n.sidebar-button-new {\n  height: 5rem;\n  width: 5rem;\n  font-size: 3rem;\n  border-radius: 50%;\n  align-self: center; }\n  .sidebar-button-new:hover {\n    box-shadow: inset 5rem 0 0 0 #55d1b6; }\n\n.hamburger {\n  display: none;\n  justify-content: center;\n  align-items: center;\n  width: 20px;\n  height: 50px;\n  flex-direction: column; }\n\n@media (max-width: 540px) {\n  .hamburger {\n    display: flex;\n    cursor: pointer;\n    margin-right: 1.65rem; }\n    .hamburger-active .line:nth-child(2) {\n      opacity: 0; }\n    .hamburger-active .line:nth-child(1) {\n      transform: translateY(8px) rotate(-315deg);\n      width: 150%; }\n    .hamburger-active .line:nth-child(3) {\n      transform: translateY(-14px) rotate(-45deg);\n      width: 150%; } }\n\n.line {\n  width: 2rem;\n  height: 3px;\n  display: block;\n  color: #f5f5f5;\n  padding: 0;\n  margin: 4px;\n  transition: 0.5s ease;\n  background-color: #f5f5f5; }\n\n.todos {\n  display: flex;\n  align-items: center;\n  flex-direction: row;\n  padding: 1rem;\n  border-radius: 4px;\n  background-color: #379683;\n  background-image: linear-gradient(315deg, #379683 0%, #5aff15 74%);\n  margin-bottom: 0.5rem;\n  transition: all 0.5s; }\n  .todos-done {\n    display: flex;\n    align-items: center;\n    flex-direction: row;\n    padding: 1rem;\n    border-radius: 4px;\n    background-color: #379683;\n    background-image: linear-gradient(315deg, #379683 0%, #5aff15 74%);\n    margin-bottom: 0.5rem;\n    opacity: 0.65; }\n  .todos:hover {\n    box-shadow: 5px 5px rgba(0, 0, 0, 0.3);\n    background-image: linear-gradient(315deg, #379683 0%, #5aff15 40%);\n    transform: scale(1.01); }\n  .todos-text {\n    margin-right: auto;\n    font-size: 1.4rem; }\n    .todos-text-done {\n      text-decoration: line-through;\n      margin-right: auto;\n      font-size: 1.4rem; }\n  .todos-input {\n    height: 1.5rem;\n    width: 1.5rem;\n    margin-right: 1.5rem; }\n  .todos-date {\n    margin-right: 2rem;\n    font-size: 1rem; }\n    .todos-date-done {\n      text-decoration: line-through;\n      margin-right: 2rem;\n      font-size: 1rem; }\n  .todos-edit {\n    margin-right: 2rem;\n    height: 2.5rem;\n    width: 4rem;\n    font-size: 1rem; }\n    .todos-edit:hover {\n      box-shadow: inset 5rem 0 0 0 #55d1b6; }\n  .todos-delete {\n    height: 2.5rem;\n    width: 4rem;\n    font-size: 1rem;\n    overflow: hidden;\n    text-overflow: ellipsis; }\n    .todos-delete:hover {\n      box-shadow: inset 5rem 0 0 0 red; }\n\n.popup-new {\n  position: fixed;\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  z-index: 1;\n  transition: all 0.3s ease;\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.edit {\n  height: 13rem;\n  width: 40rem;\n  background-color: #017d7d;\n  border-radius: 5px;\n  box-shadow: 15px 15px rgba(0, 0, 0, 0.3); }\n  .edit-header-container {\n    background-color: #379683;\n    align-items: center;\n    border-radius: 5px;\n    display: flex;\n    padding: 0.2rem;\n    box-shadow: 1px 1px rgba(0, 0, 0, 0.3); }\n    .edit-header-container-xButton {\n      color: #f81f1f;\n      font-size: 2rem;\n      margin-right: 0.7rem;\n      cursor: pointer;\n      font-weight: 900; }\n    .edit-header-container-theheader {\n      font-size: 2rem;\n      flex: auto; }\n  .edit-info-container {\n    display: flex;\n    padding: 0.2rem;\n    flex-direction: column; }\n    .edit-info-container-input-title {\n      background-color: transparent;\n      color: #f5f5f5;\n      border: none;\n      font-size: 1.25rem;\n      border-bottom: 1px solid #f5f5f5;\n      margin: 0.25rem 0rem; }\n      .edit-info-container-input-title::placeholder {\n        color: #cac7c7; }\n      .edit-info-container-input-title:focus {\n        outline: none; }\n    .edit-info-container-date-container {\n      display: flex;\n      align-items: center;\n      margin: 0.5rem 0 2.2rem 0; }\n      .edit-info-container-date-container-para {\n        font-size: 1.25rem;\n        margin-right: 0.2rem; }\n      .edit-info-container-date-container-input-date {\n        border-radius: 5px;\n        border: 2px solid #55d1b6;\n        padding: 0.5rem;\n        margin-left: 0.7rem; }\n    .edit-info-container-button {\n      height: 2rem;\n      width: 7rem;\n      align-self: end;\n      margin-right: 0.5rem; }\n      .edit-info-container-button:hover {\n        box-shadow: inset 8rem 0 0 0 #55d1b6; }\n\n.open {\n  animation: open 0.5s forwards;\n  animation-name: open; }\n\n@keyframes open {\n  0% {\n    transform: scale(0); }\n  50% {\n    transform: scale(1.2); }\n  70% {\n    transform: scale(0.95); }\n  95% {\n    transform: scale(1.1); }\n  100% {\n    transform: scale(1); } }\n\n.popup-edit {\n  position: fixed;\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  z-index: 1;\n  transition: all 0.3s ease;\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.make-new {\n  height: 13rem;\n  width: 40rem;\n  background-color: #017d7d;\n  border-radius: 5px;\n  box-shadow: 15px 15px rgba(0, 0, 0, 0.3); }\n  .make-new-header-container {\n    background-color: #379683;\n    align-items: center;\n    border-radius: 5px;\n    display: flex;\n    padding: 0.2rem;\n    box-shadow: 1px 1px rgba(0, 0, 0, 0.3); }\n    .make-new-header-container-xButton {\n      color: #f81f1f;\n      font-size: 2rem;\n      margin-right: 0.7rem;\n      cursor: pointer;\n      font-weight: 900; }\n    .make-new-header-container-theheader {\n      font-size: 2rem;\n      flex: auto; }\n  .make-new-info-container {\n    display: flex;\n    padding: 0.2rem;\n    flex-direction: column; }\n    .make-new-info-container-input-title {\n      background-color: transparent;\n      color: #f5f5f5;\n      border: none;\n      font-size: 1.25rem;\n      border-bottom: 1px solid #f5f5f5;\n      margin: 0.25rem 0rem; }\n      .make-new-info-container-input-title::placeholder {\n        color: #cac7c7; }\n      .make-new-info-container-input-title:focus {\n        outline: none; }\n    .make-new-info-container-date-container {\n      display: flex;\n      align-items: center;\n      margin: 0.5rem 0 2.2rem 0; }\n      .make-new-info-container-date-container-para {\n        font-size: 1.25rem;\n        margin-right: 0.2rem; }\n      .make-new-info-container-date-container-input-date {\n        border-radius: 5px;\n        border: 2px solid #55d1b6;\n        padding: 0.5rem;\n        margin-left: 0.7rem; }\n    .make-new-info-container-button {\n      height: 2rem;\n      width: 7rem;\n      align-self: end;\n      margin-right: 0.5rem; }\n      .make-new-info-container-button:hover {\n        box-shadow: inset 8rem 0 0 0 #55d1b6; }\n\n.hidden {\n  display: none; }\n", "",{"version":3,"sources":["webpack://./src/sass/_layout.scss","webpack://./src/sass/_colors.scss","webpack://./src/sass/_input.scss","webpack://./src/sass/_sidebar.scss","webpack://./src/sass/_todos.scss","webpack://./src/sass/_popups.scss"],"names":[],"mappings":"AAAA;EACE,SAAQ;EACR,UAAU;EACV,sBAAsB;EACtB,iBAAiB,EAAA;;AAGnB;EACE,eAAe;EAEf,kBAAkB,EAAA;EAClB;IAJF;MAKI,cAAc,EAAA,EAYjB;EAVC;IAPF;MAQI,cAAc,EAAA,EASjB;EAPC;IAVF;MAWI,cAAc,EAAA,EAMjB;EAJC;IAbF;MAcI,cAAc,EAAA,EAGjB;;AAID;EACE,aAAa;EAEb,kBAAkB;EAClB,gCAAgC;EAChC,4BAA4B;EAC5B,YAAY;EACZ,aAAa;EACb,iCCjC+B;EDkC/B,cC7Ba,EAAA;ED8Bb;IAVF;MAWI,gCAAgC,EAAA,EAYnC;EATC;IAdF;MAeI,gCAAgC,EAAA,EAQnC;EANC;IAjBF;MAkBI,gCAAgC,EAAA,EAKnC;EAHC;IApBF;MAqBI,gCAAgC,EAAA,EAEnC;;AAGD;EACE,yBChDmB;EDiDnB,kBAAkB;EAClB,eAAgB;EAChB,aAAa;EACb,yCCxD+B;EDyD/B,yBAAyB;EACzB,iBAAiB;EACjB,gBAAgB;EAChB,mBAAmB;EACnB,uBAAuB;EACvB,eAAe,EAAA;EAEb;IADF;MAEI,UAAU;MACV,4BAA4B,EAAA,EAG/B;;AAKH;EACE,yBCzEkB;ED0ElB,kBAAkB;EAClB,eAAe;EACf,aAAa;EACb,aAAa;EACb,sBAAsB;EACtB,8BAA8B;EAC9B,eAAe,EAAA;EAEf;IAVF;MAWI,eAAe,EAAA,EAUlB;EARC;IAbF;MAcI,aAAa;MACb,kBAAkB;MAClB,cAAc;MACd,YAAY;MACZ,4BAA4B,EAAA,EAG/B;;AAED;EACE,yBC/FoB;EDgGpB,kBAAkB;EAClB,eAAe;EACf,aAAa,EAAA;EACb;IALF;MAMI,kBAAkB,EAAA,EAErB;;AAED;EACE,eAAe;EACf,yBCnG4B;EDoG5B,mBCzGa;ED0Gb,kBAAkB;EAClB,iBAAiB;EACjB,kBAAkB;EAClB,cAAsB,EAAA;EAPxB;IASE,wBAAwB;IAExB,eAAe;IACf,cClHa,EAAA;EDsGf;IAeI,qBAAsB,EAAA;;AE7H1B;EACE,aAAa,EAAA;;ACAf;EACE,gBAAgB,EAAA;EAChB;IACE,eAAe;IACf,aAAa;IACb,yBAAyB,EAAA;IAH1B;MAOC,cFNe;MEOf,gBAAgB;MAChB,6BAA4B,EAAA;;AAKhC;EACE,cFdiB;EEejB,gBAAgB;EAChB,6BAA4B;EAC5B,eAAe;EACf,aAAa;EACb,yBAAyB,EAAA;;AAG3B;EACE,YAAY;EACZ,WAAW;EACX,eAAe;EACf,kBAAkB;EAClB,kBAAkB,EAAA;EALpB;IAOI,oCFpB0B,EAAA;;AEyB9B;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,WAAW;EACX,YAAY;EACZ,sBAAsB,EAAA;;AAExB;EACE;IACE,aAAa;IACb,eAAe;IACf,qBAAqB,EAAA;IACpB;MAGK,UAAU,EAAA;IAHf;MAMK,0CAA0C;MAC1C,WAAW,EAAA;IAPhB;MAUK,2CAA2C;MAC3C,WAAW,EAAA,EACZ;;AAOT;EACE,WAAW;EACX,WAAW;EACX,cAAc;EACd,cFlEa;EEmEb,UAAU;EACV,WAAW;EACX,qBAAqB;EACrB,yBFtEa,EAAA;;AGPf;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,aAAa;EACb,kBAAkB;EAClB,yBHFkB;EGGlB,kEAA0E;EAC1E,qBAAqB;EACrB,oBAAoB,EAAA;EACpB;IACE,aAAa;IACb,mBAAmB;IACnB,mBAAmB;IACnB,aAAa;IACb,kBAAkB;IAClB,yBHZgB;IGahB,kEAA0E;IAC1E,qBAAqB;IACrB,aAAa,EAAA;EAnBjB;IAsBI,sCAAmC;IACnC,kEAA0E;IAC1E,sBAAsB,EAAA;EAExB;IACE,kBAAkB;IAClB,iBAAiB,EAAA;IACjB;MACE,6BAA4B;MAC5B,kBAAkB;MAClB,iBAAiB,EAAA;EAKrB;IACE,cAAc;IACd,aAAa;IACb,oBAAoB,EAAA;EAItB;IACE,kBAAkB;IAClB,eAAe,EAAA;IACf;MACE,6BAA4B;MAC5B,kBAAkB;MAClB,eAAe,EAAA;EAOnB;IACE,kBAAkB;IAClB,cAAc;IACd,WAAW;IACX,eAAe,EAAA;IAJhB;MAMG,oCHnDwB,EAAA;EGsD5B;IACE,cAAc;IACd,WAAW;IACX,eAAe;IACf,gBAAgB;IAChB,uBAAuB,EAAA;IALxB;MAOG,gCAAgC,EAAA;;AC1EtC;EACE,eAAe;EACf,aAAa;EACb,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,UAAU;EACV,yBAAyB;EACzB,oCAAoC,EAAA;;AAMtC;EACE,aAAa;EACb,YAAY;EACZ,yBJRqB;EISrB,kBAAkB;EAElB,wCAAqC,EAAA;EACrC;IACE,yBJlBgB;IImBhB,mBAAmB;IACnB,kBAAkB;IAClB,aAAa;IACb,eAAe;IACf,sCAAmC,EAAA;IAEnC;MACE,cJpBgB;MIqBhB,eAAe;MACf,oBAAoB;MACpB,eAAe;MACf,gBAAgB,EAAA;IAElB;MACE,eAAe;MACf,UAAU,EAAA;EAGd;IACE,aAAa;IACb,eAAe;IACf,sBAAsB,EAAA;IACtB;MACE,6BAA6B;MAC7B,cJxCS;MIyCT,YAAY;MACZ,kBAAkB;MAClB,gCJ3CS;MI4CT,oBAAoB,EAAA;MANrB;QAQG,cJ1CM,EAAA;MIkCT;QAWG,aAAa,EAAA;IAGjB;MACE,aAAa;MACb,mBAAmB;MACnB,yBAAyB,EAAA;MACzB;QACE,kBAAkB;QAClB,oBAAoB,EAAA;MAEtB;QACE,kBAAkB;QAClB,yBJzDsB;QI0DtB,eAAe;QACf,mBAAmB,EAAA;IAGvB;MACE,YAAY;MACZ,WAAW;MACX,eAAe;MACf,oBAAoB,EAAA;MAJrB;QAMG,oCJpEsB,EAAA;;AI0E9B;EACE,6BAA6B;EAC7B,oBAAoB,EAAA;;AAItB;EACE;IACE,mBAAmB,EAAA;EAErB;IACE,qBAAqB,EAAA;EAEvB;IACE,sBAAsB,EAAA;EAExB;IACE,qBAAqB,EAAA;EAEvB;IACE,mBAAmB,EAAA,EAAA;;AAKvB;EACE,eAAe;EACf,aAAa;EACb,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,UAAU;EACV,yBAAyB;EACzB,oCAAoC,EAAA;;AAMtC;EACE,aAAa;EACb,YAAY;EACZ,yBJxHqB;EIyHrB,kBAAkB;EAElB,wCAAqC,EAAA;EACrC;IACE,yBJlIgB;IImIhB,mBAAmB;IACnB,kBAAkB;IAClB,aAAa;IACb,eAAe;IACf,sCAAmC,EAAA;IAEnC;MACE,cJpIgB;MIqIhB,eAAe;MACf,oBAAoB;MACpB,eAAe;MACf,gBAAgB,EAAA;IAElB;MACE,eAAe;MACf,UAAU,EAAA;EAGd;IACE,aAAa;IACb,eAAe;IACf,sBAAsB,EAAA;IACtB;MACE,6BAA6B;MAC7B,cJxJS;MIyJT,YAAY;MACZ,kBAAkB;MAClB,gCJ3JS;MI4JT,oBAAoB,EAAA;MANrB;QAQG,cJ1JM,EAAA;MIkJT;QAWG,aAAa,EAAA;IAGjB;MACE,aAAa;MACb,mBAAmB;MACnB,yBAAyB,EAAA;MACzB;QACE,kBAAkB;QAClB,oBAAoB,EAAA;MAEtB;QACE,kBAAkB;QAClB,yBJzKsB;QI0KtB,eAAe;QACf,mBAAmB,EAAA;IAGvB;MACE,YAAY;MACZ,WAAW;MACX,eAAe;MACf,oBAAoB,EAAA;MAJrB;QAMG,oCJpLsB,EAAA;;AI2L9B;EACE,aAAa,EAAA","sourcesContent":["*,*::after, *::before{\r\n  margin:0;\r\n  padding: 0;\r\n  box-sizing: border-box;\r\n  user-select: none;\r\n}\r\n// Change fonts when the screen get smaller\r\nhtml{\r\n  font-size: 100%;\r\n  // Overflow-x hidden so when the screen goes really small theres no scrollbar\r\n  overflow-x: hidden;\r\n  @media (max-width: 1000px){\r\n    font-size: 90%;\r\n  }\r\n  @media (max-width: 800px){\r\n    font-size: 80%;\r\n  }\r\n  @media (max-width: 650px){\r\n    font-size: 70%;\r\n  }\r\n  @media (max-width: 400px){\r\n    font-size: 60%;\r\n  }\r\n\r\n}\r\n\r\n\r\n// Change screen layout according to the size\r\nbody {\r\n  display: grid;\r\n  // Needed to work on mobile view\r\n  overflow-x: hidden;\r\n  grid-template-columns: 20rem 1fr;\r\n  grid-template-rows: 5rem 1fr;\r\n  width: 100vw;\r\n  height: 100vh;\r\n  font-family: $font-stack;\r\n  color: $white;\r\n  @media (max-width: 1000px){\r\n    grid-template-columns: 17rem 1fr;\r\n  }\r\n\r\n  @media (max-width: 800px){\r\n    grid-template-columns: 13rem 1fr;\r\n  }\r\n  @media (max-width: 650px){\r\n    grid-template-columns: 10rem 1fr;\r\n  }\r\n  @media (max-width: 540px){\r\n    grid-template-columns: 1fr 20rem;\r\n  }\r\n}\r\n\r\n\r\n.header{\r\n  background-color: $green-light;\r\n  grid-column: 1 / 3;\r\n  grid-row: 1 / 2 ;\r\n  display: flex;\r\n  font-family:Impact,$font-stack;\r\n  transition: all 0.5s ease;\r\n  font-size: 3.5rem;\r\n  font-weight: 500;\r\n  align-items: center;\r\n  justify-content: center;\r\n  padding: 0.5rem;\r\n  &-text{\r\n    @media (max-width: 540px){\r\n      flex: auto;\r\n      transition: 0.2s ease-in-out;\r\n    }\r\n    \r\n  }\r\n}\r\n\r\n\r\n\r\n.sidebar{\r\n  background-color: $green-blue;\r\n  grid-column: 1 / 2;\r\n  grid-row: 2 / 3;\r\n  padding: 3rem;\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: space-between;\r\n  font-size: 2rem;\r\n\r\n  @media (max-width: 800px){\r\n    padding: 1.5rem;\r\n  }\r\n  @media (max-width: 540px){\r\n    padding: 1rem;\r\n    position: relative;\r\n    grid-column: 2;\r\n    left: 1000px;\r\n    transition: 0.2s ease-in-out;\r\n  }\r\n\r\n}\r\n\r\n.main{\r\n  background-color: $green-bright;\r\n  grid-column: 2 / 3;\r\n  grid-row: 2 / 3;\r\n  padding: 2rem;\r\n  @media (max-width: 540px){\r\n    grid-column: 1 / 3;\r\n  }\r\n}\r\n\r\nbutton{\r\n  cursor: pointer;\r\n  border: solid 2px $blue-light;\r\n  background: $white;\r\n  text-align: center;\r\n  font-weight: bold;\r\n  border-radius: 4px;\r\n  color: rgb(11, 11, 15);\r\n  &:hover{\r\n  transition: ease-in 0.2s;\r\n  //box-shadow: inset 10rem 0 0 0 $blue-light;\r\n  cursor: pointer;\r\n  color: $white;\r\n  }\r\n  &:active{\r\n    transform: scale(0.80);\r\n  }\r\n}\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n","@import url('https://fonts.googleapis.com/css2?family=Overpass:ital,wght@0,300;0,500;0,700;1,300;1,500;1,700&display=swap');\r\n\r\n\r\n$font-stack: Overpass, sans-serif;\r\n$blue-dark: #05386B;\r\n$green-blue: #379683;\r\n$green-bright: #5CDB95;\r\n$green-light: #8EE4AF;\r\n$white: #f5f5f5;\r\n$green-neon: #5aff15;\r\n$blue: rgb(1, 125, 125);\r\n$red: rgb(248, 31, 31);\r\n$grey: #cac7c7;\r\n$blue-light: rgb(85, 209, 182);",".header-container {\r\n  display: flex;\r\n}\r\n\r\n","//sidebar styles\r\n.menu{\r\n  list-style: none;\r\n  &-item{\r\n    cursor: pointer;\r\n    padding: 1rem;\r\n    transition: all 0.5s ease;\r\n\r\n  \r\n  &:hover{\r\n    color: $blue-dark;\r\n    font-weight: 700;\r\n    transform: translateX(.5rem);\r\n  }\r\n  }\r\n}\r\n\r\n.highlighted{\r\n  color: $blue-dark;\r\n  font-weight: 700;\r\n  transform: translateX(.5rem);\r\n  cursor: pointer;\r\n  padding: 1rem;\r\n  transition: all 0.5s ease;\r\n}\r\n\r\n.sidebar-button-new{\r\n  height: 5rem;\r\n  width: 5rem;\r\n  font-size: 3rem;\r\n  border-radius: 50%;\r\n  align-self: center;\r\n  &:hover{\r\n    box-shadow: inset 5rem 0 0 0 $blue-light;\r\n  }\r\n  \r\n}\r\n\r\n.hamburger{\r\n  display: none;\r\n  justify-content: center;\r\n  align-items: center;\r\n  width: 20px;\r\n  height: 50px;\r\n  flex-direction: column;\r\n}\r\n@media (max-width: 540px){\r\n  .hamburger{\r\n    display: flex;\r\n    cursor: pointer;\r\n    margin-right: 1.65rem;\r\n    &-active{\r\n      .line{\r\n        &:nth-child(2) {\r\n          opacity: 0;\r\n        }\r\n        &:nth-child(1) {\r\n          transform: translateY(8px) rotate(-315deg);\r\n          width: 150%;\r\n        }\r\n        &:nth-child(3) {\r\n          transform: translateY(-14px) rotate(-45deg);\r\n          width: 150%;\r\n        }\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\n\r\n.line{\r\n  width: 2rem;\r\n  height: 3px;\r\n  display: block;\r\n  color: $white;\r\n  padding: 0;\r\n  margin: 4px;\r\n  transition: 0.5s ease;\r\n  background-color: $white;\r\n}","// All the code for the details in the main container\r\n.todos {\r\n  display: flex;\r\n  align-items: center;\r\n  flex-direction: row;\r\n  padding: 1rem;\r\n  border-radius: 4px;\r\n  background-color: $green-blue;\r\n  background-image: linear-gradient(315deg, $green-blue 0%, $green-neon 74%);\r\n  margin-bottom: 0.5rem;\r\n  transition: all 0.5s;\r\n  &-done{\r\n    display: flex;\r\n    align-items: center;\r\n    flex-direction: row;\r\n    padding: 1rem;\r\n    border-radius: 4px;\r\n    background-color: $green-blue;\r\n    background-image: linear-gradient(315deg, $green-blue 0%, $green-neon 74%);\r\n    margin-bottom: 0.5rem;\r\n    opacity: 0.65;\r\n  }\r\n  &:hover{\r\n    box-shadow: 5px 5px rgba(0,0,0,0.3);\r\n    background-image: linear-gradient(315deg, $green-blue 0%, $green-neon 40%);\r\n    transform: scale(1.01);\r\n  }\r\n  &-text {\r\n    margin-right: auto;\r\n    font-size: 1.4rem;\r\n    &-done{\r\n      text-decoration:line-through;\r\n      margin-right: auto;\r\n      font-size: 1.4rem;\r\n    }\r\n  }\r\n\r\n  // Checkmark when todo is done\r\n  &-input{\r\n    height: 1.5rem;\r\n    width: 1.5rem;\r\n    margin-right: 1.5rem;\r\n  }\r\n\r\n\r\n  &-date{\r\n    margin-right: 2rem;\r\n    font-size: 1rem;\r\n    &-done{\r\n      text-decoration:line-through;\r\n      margin-right: 2rem;\r\n      font-size: 1rem;\r\n    }\r\n  }\r\n\r\n\r\n\r\n  // The buttons on the main todo\r\n  &-edit{\r\n    margin-right: 2rem;\r\n    height: 2.5rem;\r\n    width: 4rem;\r\n    font-size: 1rem;\r\n    &:hover{\r\n      box-shadow: inset 5rem 0 0 0 $blue-light;\r\n    }\r\n  }\r\n  &-delete{\r\n    height: 2.5rem;\r\n    width: 4rem;\r\n    font-size: 1rem;\r\n    overflow: hidden;\r\n    text-overflow: ellipsis;\r\n    &:hover{\r\n      box-shadow: inset 5rem 0 0 0 red;\r\n    }\r\n    \r\n  }\r\n}\r\n",".popup-new{\r\n  position: fixed;\r\n  height: 100vh;\r\n  width: 100vw;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n  z-index: 1;\r\n  transition: all 0.3s ease;\r\n  background-color: rgba(0, 0, 0, 0.8);\r\n\r\n}\r\n\r\n\r\n//pop up form to add a new one\r\n.edit{\r\n  height: 13rem;\r\n  width: 40rem;\r\n  background-color: $blue;\r\n  border-radius: 5px;\r\n  \r\n  box-shadow: 15px 15px rgba(0,0,0,0.3);\r\n  &-header-container{\r\n    background-color: $green-blue;\r\n    align-items: center;\r\n    border-radius: 5px;\r\n    display: flex;\r\n    padding: 0.2rem;\r\n    box-shadow: 1px 1px rgba(0,0,0,0.3);\r\n    //button to close the popup\r\n    &-xButton{\r\n      color: $red;\r\n      font-size: 2rem;\r\n      margin-right: 0.7rem;\r\n      cursor: pointer;\r\n      font-weight: 900;\r\n    }\r\n    &-theheader{\r\n      font-size: 2rem;\r\n      flex: auto;\r\n    }\r\n  }\r\n  &-info-container{\r\n    display: flex;\r\n    padding: 0.2rem;\r\n    flex-direction: column;\r\n    &-input-title{\r\n      background-color: transparent;\r\n      color: $white;\r\n      border: none;\r\n      font-size: 1.25rem;\r\n      border-bottom: 1px solid $white;\r\n      margin: 0.25rem 0rem;\r\n      &::placeholder{\r\n        color: $grey;\r\n      }\r\n      &:focus{\r\n        outline: none;\r\n      }\r\n    }\r\n    &-date-container{\r\n      display: flex;\r\n      align-items: center;\r\n      margin: 0.5rem 0 2.2rem 0;\r\n      &-para{\r\n        font-size: 1.25rem;\r\n        margin-right: 0.2rem;\r\n      }\r\n      &-input-date{\r\n        border-radius: 5px;\r\n        border: 2px solid $blue-light;\r\n        padding: 0.5rem;\r\n        margin-left: 0.7rem;\r\n      }\r\n    }\r\n    &-button{\r\n      height: 2rem;\r\n      width: 7rem;\r\n      align-self: end;\r\n      margin-right: 0.5rem;\r\n      &:hover{\r\n        box-shadow: inset 8rem 0 0 0 $blue-light;\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\n.open{\r\n  animation: open 0.5s forwards;\r\n  animation-name: open;\r\n}\r\n\r\n\r\n@keyframes open {\r\n  0%{\r\n    transform: scale(0);\r\n  }\r\n  50%{\r\n    transform: scale(1.2);\r\n  }\r\n  70%{\r\n    transform: scale(0.95);\r\n  }\r\n  95%{\r\n    transform: scale(1.1);\r\n  }\r\n  100%{\r\n    transform: scale(1);\r\n  }\r\n};\r\n\r\n\r\n.popup-edit{\r\n  position: fixed;\r\n  height: 100vh;\r\n  width: 100vw;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n  z-index: 1;\r\n  transition: all 0.3s ease;\r\n  background-color: rgba(0, 0, 0, 0.8);\r\n\r\n}\r\n\r\n\r\n// Edit window\r\n.make-new{\r\n  height: 13rem;\r\n  width: 40rem;\r\n  background-color: $blue;\r\n  border-radius: 5px;\r\n  \r\n  box-shadow: 15px 15px rgba(0,0,0,0.3);\r\n  &-header-container{\r\n    background-color: $green-blue;\r\n    align-items: center;\r\n    border-radius: 5px;\r\n    display: flex;\r\n    padding: 0.2rem;\r\n    box-shadow: 1px 1px rgba(0,0,0,0.3);\r\n    //button to close the popup\r\n    &-xButton{\r\n      color: $red;\r\n      font-size: 2rem;\r\n      margin-right: 0.7rem;\r\n      cursor: pointer;\r\n      font-weight: 900;\r\n    }\r\n    &-theheader{\r\n      font-size: 2rem;\r\n      flex: auto;\r\n    }\r\n  }\r\n  &-info-container{\r\n    display: flex;\r\n    padding: 0.2rem;\r\n    flex-direction: column;\r\n    &-input-title{\r\n      background-color: transparent;\r\n      color: $white;\r\n      border: none;\r\n      font-size: 1.25rem;\r\n      border-bottom: 1px solid $white;\r\n      margin: 0.25rem 0rem;\r\n      &::placeholder{\r\n        color: $grey;\r\n      }\r\n      &:focus{\r\n        outline: none;\r\n      }\r\n    }\r\n    &-date-container{\r\n      display: flex;\r\n      align-items: center;\r\n      margin: 0.5rem 0 2.2rem 0;\r\n      &-para{\r\n        font-size: 1.25rem;\r\n        margin-right: 0.2rem;\r\n      }\r\n      &-input-date{\r\n        border-radius: 5px;\r\n        border: 2px solid $blue-light;\r\n        padding: 0.5rem;\r\n        margin-left: 0.7rem;\r\n      }\r\n    }\r\n    &-button{\r\n      height: 2rem;\r\n      width: 7rem;\r\n      align-self: end;\r\n      margin-right: 0.5rem;\r\n      &:hover{\r\n        box-shadow: inset 8rem 0 0 0 $blue-light;\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\n\r\n.hidden{\r\n  display: none;\r\n}"],"sourceRoot":""}]);
// Exports
  ...
  const getAllTodos = (todos, main) => {
    ...
    for (const todo in todos) {
      todos[todo].forEach((todo, i) => {
        ...
        const day = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(dateValue, 'do');
        const month = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(dateValue, 'MMM');
...
if(!localStorage.getItem("todos")){
  todos.month.push(_toDos__WEBPACK_IMPORTED_MODULE_1__.toDosManager.createToDo("Eat nuts","2023-12-12"));
  todos.month.push(_toDos__WEBPACK_IMPORTED_MODULE_1__.toDosManager.createToDo("Eat bigger nuts","2023-11-11"));
}


_toDos__WEBPACK_IMPORTED_MODULE_1__.toDosManager.getAllTodos(todos, main);
...
popCreateNewSubmitButton.addEventListener('click', e => {
  _toDos__WEBPACK_IMPORTED_MODULE_1__.toDosManager.addToDo(e, todos, main, popUpNew, formNew);
...
const sidebar = document.querySelector(".sidebar");
  ...
  function folderChange(){
    ...
    if(folder === 'home') {
      ...
      _toDos__WEBPACK_IMPORTED_MODULE_1__.toDosManager.getCertainStateTodos(todos, main, folder);
    }
  };
